...
func validate(cfg *Config) error {
	...
	for i, d := range cfg.Devices {
		...
		seen[d.ID] = true
		if !map[string]bool{"rest": true, "websocket": true, "telnet": true, "serial": true, "tesira": true, "sony_bravia": true, "poly_videoos": true, "cisco_roomos": true, "aurora_rxt": true, "aurora_vpx": true, "ping": true}[d.Protocol] {
