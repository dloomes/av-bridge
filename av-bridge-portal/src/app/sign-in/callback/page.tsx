...
// Landing page for the Entra vendor SSO flow.
//
// The cloud's callback handler mints an `av_` session token, then 302s the
// browser to `/sign-in/callback?token=<token>`. This page picks the token
// out of the URL, stores it (same shape as password login), fetches
...
// here — this page is a transient landing pad, not a destination.
